...
function Login(props){
  ...
  return (
  <div className={`lg:min-h-full absolute lg:items-center lg:justify-center py-12 px-4 sm:px-6 lg:px-8 lg:visible ${logInVisiblity} w-96 h-min border border-transparent m`}>
